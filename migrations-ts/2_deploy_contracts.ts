...
module.exports = async (
  ...
  if (network === "bsc") {
    await deployer.deploy(
      NFTKEYMarketPlaceV1_1,
      "NFCs",
      "0x69799454f8c742690E20a34B953521fdA013159E", // Non-Fungible Cowboys
      "0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c" // WBNB
    );
    const marketplaceV1 = await NFTKEYMarketPlaceV1_1.deployed();
    console.log(
      `NFTKEYMarketPlaceV1_1 for Non-Fungible Cowboys deployed at ${marketplaceV1.address} in network: ${network}.`
    );
  }
