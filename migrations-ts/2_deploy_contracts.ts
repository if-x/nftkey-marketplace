...
module.exports = async (
  ...
  if (network === "bsctestnet") {
    ...
    console.log(
      `NFTKEYMarketPlaceV1 for Life deployed at ${marketplaceV1.address} in network: ${network}.`
    );
  }
  ...
  if (network === "bsc") {
    await deployer.deploy(
      NFTKEYMarketPlaceV1,
      "Life",
      "0xA205585368917366CCE212EecC754F6d055A2e8E", // Life
  ...
  if (network === "main") {
    await deployer.deploy(
      NFTKEYMarketPlaceV1,
      "Life",
      "0x24DE7018b2C73B5437eaF647e914a9042CC6D770", // Life
